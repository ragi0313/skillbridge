        ...
        <div className="container mx-auto px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            ...
            <article className="space-y-12">
              ...
              <p>All community participants are expected to:</p>
              ...
              <p>If you experience or witness behavior that violates this Code of Conduct, please report it promptly using one of the following methods:</p>
              ...
              <h2>Investigation and Response</h2>
              ...
              <p>Depending on the severity and nature of the violation, consequences may include:</p>

              <h4>First-Time Minor Violations</h4>
              <ul>
              ...
              <h4>Serious or Repeat Violations</h4>
              <ul>
              ...
              <h2>Mentoring-Specific Guidelines</h2>
              ...
              <h3>Cross-Cultural Interactions</h3>
              <ul>
              ...
              <h3>Learner Responsibilities</h3>
              <p>Learners additionally must:</p>
              <ul>
              ...
              <h2>Philippine Legal Framework</h2>

              <h3>Cybercrime Prevention Act Compliance</h3>
              <ul>
