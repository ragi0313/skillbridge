...
export function MentorApplicationCard({ mentor, onApprove, onReject }: MentorApplicationCardProps) {
        ...
        <div className="flex justify-between items-start">
          <div className="flex items-start space-x-4">
            <Avatar className="w-20 h-20 border-4 border-white shadow-lg">
              <AvatarImage src={mentor.profilePictureUrl || "/placeholder.svg"} alt={name} />
            ...
            <div className="flex-1">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3 text-sm">
                ...
                <div className="flex items-center text-gray-600">
                  ...
                  <span>
                    {mentor.yearsOfExperience} {mentor.yearsOfExperience === 1 ? "year" : "years"} experience
                  </span>
                </div>
                <div className="flex items-center text-gray-600">
          ...
          <div className="flex flex-col space-y-2">
            <MentorReviewDialog mentor={mentor} onApprove={onApprove} onReject={onReject} />
          </div>
        </div>
      </CardHeader>
      ...
      <CardContent className="pt-0">
        ...
        <div className="space-y-4">
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              {mentor.skills.slice(0, 4).map((skill, index) => (
                <div key={index} className="flex items-center space-x-2 bg-gray-50 rounded-lg px-3 py-2 border">
          ...
          <div>
            ...
            <p className="text-gray-600 text-sm line-clamp-2 leading-relaxed">{mentor.bio}</p>
          </div>
        </div>
      </CardContent>
    </Card>
