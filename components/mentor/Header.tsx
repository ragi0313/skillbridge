  ...
  useEffect(() => {
    async function fetchData() {
      try {
        ...
        if (!mentorRes.ok) {
          throw new Error(`Failed to fetch mentor profile: ${mentorRes.status}`)
        }
        
        const mentorData = await safeJsonParse(mentorRes)
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2 sm:space-x-4">
            ...
            >
              ...
              <span className="lg:hidden">{mentor.creditsBalance}</span>
            </Badge>
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button
                  variant="ghost"
                  className="relative h-10 w-10 rounded-full hover:bg-gray-800 cursor-pointer"
                >
                  <Avatar className="h-10 w-10">
                    <AvatarImage
                      src={mentor.profilePictureUrl || "/default-avatar.png"}
                      alt="Profile"
                    />
                  </Avatar>
                </Button>
            ...
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 border-t border-gray-700 mt-4">
              ...
              <div className="sm:hidden mb-3 px-3 py-2 bg-gray-800 rounded-md flex items-center justify-between">
                <div className="flex items-center">
                  ...
                  <span className="text-sm font-medium text-white">{mentor.creditsBalance} credits</span>
                </div>
                <Link href="/mentor/withdrawals" onClick={() => setIsMenuOpen(false)}>
