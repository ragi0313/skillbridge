...
export default function MentorAvailability({ formData, setFormData, nextStep, prevStep, isSettingsPage = false }: Props) {
  ...
  const isFormValid = () => {
    ...
    // For settings page, make personal questions optional
    if (isSettingsPage) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Personal Questions - Show different behavior for settings vs registration */}
      {!isSettingsPage && (
